CBL NODYNAM,OBJECT,APOST,NOSEQ
      **************************************************************
      * YYOACTJP - OPEN ACCOUNT FOR CICS AND DB2.
      **************************************************************
      ...
      **************************************************************
       ...
       01  WS-ME                             PIC X(9) VALUE "YYOACTJP".
       01  WS-HEX-OUTPUT                       PIC X(60).
      ...
      **************************************************************
        01 DFHCOMMAREA.
          03 IN-PUT.
             ...
             05 ACTI-CUSTOMER-NAME           PIC G(16) USAGE DISPLAy-1.
             05 ACTI-ZIP-CODE                PIC X(10).
             05 ACTI-ADDRESS                 PIC G(30) USAGE DISPLAy-1.
             05 ACTI-TYPCD                   PIC X.
      ...
      **************************************************************
       GET-INPUT.
           ...
           DISPLAY WS-ME 'ACCOUNT-ID: ' ACTI-ACCOUNT-ID.
       GET-INPUT-END.
           EXIT.
      **************************************************************
       HANDLE-INPUT.
           ...
           IF ACTI-BRNCH-ID IS ZERO
            ...
            MOVE ACTI-ZIP-CODE TO ACTO-ZIP-CODE.
            MOVE ACTI-ADDRESS TO ACTO-ADDRESS.
      ...
      **************************************************************
       DO-SQL.
           DISPLAY WS-ME "Before INSERT ------------".
           DISPLAY WS-ME "ACTO-ACCOUNT-ID Ý" ACTO-ACCOUNT-ID "¨".
           DISPLAY WS-ME "ACTO-CUSTOMER-ID Ý" ACTO-CUSTOMER-ID "¨".
           DISPLAY WS-ME "ACTO-CUSTOMER-NAME Ý" ACTO-CUSTOMER-NAME "¨".
           MOVE FUNCTION HEX-OF(ACTO-CUSTOMER-NAME) to WS-HEX-OUTPUT.
           DISPLAY WS-ME "ACTO-CUSTOMER-NAME in Hex:" WS-HEX-OUTPUT.
           DISPLAY WS-ME "ACTO-ZIP-CODE Ý" ACTO-ZIP-CODE "¨".
           DISPLAY WS-ME "ACTO-IBAN Ý" ACTO-IBAN "¨".
           DISPLAY WS-ME "ACTO-BNK-ID Ý" ACTO-BNK-ID "¨".
           DISPLAY WS-ME "ACTO-BRNCH-ID Ý" ACTO-BRNCH-ID "¨".
           DISPLAY WS-ME "ACTO-CNTRY-CD Ý" ACTO-CNTRY-CD "¨".
           DISPLAY WS-ME "ACTO-TYPCD Ý" ACTO-TYPCD "¨".
           DISPLAY WS-ME "ACTO-SUB-TYPCD Ý" ACTO-SUB-TYPCD "¨".
           DISPLAY WS-ME "ACTO-TYPE-NAME Ý" ACTO-TYPE-NAME "¨".
           DISPLAY WS-ME "ACTO-TYPE-DESCRIPTION Ý"
              ACTO-TYPE-DESCRIPTION "¨".
           DISPLAY WS-ME "ACTO-BALANCE Ý" ACTO-BALANCE "¨".
           DISPLAY WS-ME "ACTO-CURRENCY Ý" ACTO-CURRENCY "¨".
           DISPLAY WS-ME "ACTO-CRT-DT Ý" ACTO-CRT-DT "¨".
           DISPLAY WS-ME "ACTO-UPDT-DT Ý" ACTO-UPDT-DT "¨".
           DISPLAY WS-ME "ACTO-LOCKED Ý" ACTO-LOCKED "¨".

            EXEC SQL
                  INSERT INTO YOICHIY.ACCOUNTJP (
                     ACCOUNT_ID,
                     CUSTOMER_ID,
                     CUSTOMER_NAME,
                     ZIP_CODE,
      ...
      **************************************************************
       DO-POSTSQL.
            ...
            IF SQLCODE = 0
               ...
               DISPLAY WS-ME 'ACCOUNT = ' ACTW-ACCOUNT-ID
               IF ACTO-BALANCE = 0
                  MOVE 1.111 TO ACTO-BALANCE
               END-IF
            ELSE
               MOVE 'INSERT NOT SUCCESSFUL' TO RT-MSG
               DISPLAY WS-ME 'SQLCODE:  ' SQLCODE
