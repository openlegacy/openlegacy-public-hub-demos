CBL NODYNAM,OBJECT,APOST,NOSEQ
      **************************************************************
      * YYGACTJP - GET AN ACCOUNT FOR CICS AND DB2.
      **************************************************************
      ...
      ****************************************************
        ...
        01 WS-ME                    PIC X(9) VALUE "YYGACTJP".
      **************************************************************
        LINKAGE SECTION.
      **************************************************************
        01 DFHCOMMAREA.
            ...
            MOVE LOW-VALUES TO ACCOUNT-OUT
              ...
              EXEC SQL
                ...
                INTO
                  ...
                  :ACTO-UPDT-DT,
                  :ACTO-LOCKED
                 FROM YOICHIY.ACCOUNTJP WHERE
                   ACCOUNT_ID = :ACTW-ACCOUNT-ID
              END-EXEC.
      ...
      **************************************************************
       DO-POSTSQL.
            IF SQLCODE = 0
               ...
               DISPLAY WS-ME ' CUSTOMER = ' ACTW-CUSTOMER-NAME
               IF ACTO-BALANCE = 0
      ...
      *
               IF SQLSTATE = 02000 THEN
                 MOVE 'RECORD NOT FOUND' TO RT-MSG
               ELSE
                 MOVE 'ERROR READING RECORD' TO RT-MSG
               END-IF
            END-IF.
       DO-POSTSQL-END.
           EXIT.
